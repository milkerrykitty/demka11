...
namespace template
{
    ...
    {
        private string connectionString = "server=localhost;user=root;database=zoo;password=root;";
        public UserForm()
        {
            InitializeComponent();
        ...
        private void btnAddUser_Click(object sender, EventArgs e)
        {
            ...
            string fullname = txtFullName.Text; // ✅ Новое поле
            ...
            string connectionString = "server=localhost;user=root;database=zoo;password=root;";
            using (MySqlConnection connection = new MySqlConnection(connectionString))
            {
                try
                {
        ...
        private void btnEditUser_Click(object sender, EventArgs e)
        {
            ...
            string accountStatus = oldAccountStatus; // Предположим, что статус аккаунта не меняем
        ...
        private void ClearFields()
        {
            ...
            txtFullName.Clear(); // ✅
            cmbRole.SelectedIndex = 0;
            cmbStatus.SelectedIndex = 1; // ✅ По умолчанию "Работает"
        }
    }
}
